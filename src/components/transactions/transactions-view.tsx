    ...
    <>
      <div className="grid grid-cols-1 gap-space-md sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <span className="text-label-md uppercase tracking-widest">Exportar Relatório</span>
        </button>
      </div>
                ...
                >
                  ...
                  <td
                    className={`p-space-md text-right text-body-md font-medium ${
                      transaction.kind === "receita" ? "text-success" : "text-on-surface"
                    }`}
                  >
...
function StatCard({
  ...
  return (
    <div className="rounded-xl bg-surface-container p-space-md shadow-sm">
      ...
      <div className={`mt-space-xs text-headline-md ${valueClass}`}>{value}</div>
    </div>
  );
}
...
function LoadingSkeleton() {
  return (
    <div className="flex animate-pulse flex-col gap-space-lg">
      <div className="grid grid-cols-1 gap-space-md sm:grid-cols-2 lg:grid-cols-4">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="h-32 rounded-xl bg-surface-container-low shadow-sm" />
        ))}
      </div>
